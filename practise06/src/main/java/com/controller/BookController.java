...
public class BookController {
    ...
    @GetMapping("/list")
    public Result <List<Book>>findAll() {return Result.success( bookService.findAll());}
    @GetMapping("/getById")
    public Result<Book>findById(@RequestParam int id) { return Result.success(bookService.findById(id));}
    @GetMapping("/findByCategory")
    public  Result<List<Book>> findByCategory(@RequestParam String category) {return Result.success( bookService.findByCategory(category));}
    @PostMapping("/add")
    public Result<Integer> insert(@RequestBody Book book) {return Result.success(bookService.insert(book));}
    @DeleteMapping("/delete")
    public Result<Integer> delete(@RequestParam int id) {return Result.success(bookService.delete(id));}
}
